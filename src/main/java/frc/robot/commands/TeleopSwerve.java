...
public class TeleopSwerve extends Command{
    ...
    translationSlewRateLimiter = new SlewRateLimiter(.03); //originally 2.5
    strafeSlewRateLimiter = new SlewRateLimiter(.03);
    rotationSlewRateLimiter = new SlewRateLimiter(.03);
